...
# STEP 5.3: OBTAIN REGIONS BELOW MINIMUM COVERAGE IN EACH SAMPLE
...
OUTPUT = list(
    ...
    COV.PREFIX = paste0("CovBelow", MIN.COV, "_")
)
...
MEM = 5000
QUEUE = "long"
COV.CMD = "bedtools genomecov -ibam ${BAM} -bg | awk '\\$4 < ${MINCOV}' | bedtools merge > ${OUTFILE}"
